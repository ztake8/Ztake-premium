  ...
  return (
    <nav
      className={cn(
        ...
        scrolled
          ? "backdrop-blur-[40px] bg-white/70 dark:bg-black/70 border-b border-white/20 dark:border-white/10 shadow-sm py-2"
          : "backdrop-blur-[10px] bg-transparent border-b border-transparent py-4"
      )}
    >
            ...
            <div className="flex items-center gap-3 cursor-pointer group">
              <div className="relative">
                ...
                <img
                  src="/ztake-logo.png"
                  alt="Ztake Logo"
                  className="h-10 w-auto select-none relative z-10 transition-transform duration-500 group-hover:scale-110"
                />
              </div>
              <span className="text-sm tracking-wide text-foreground inline font-bold group-hover:text-primary transition-colors duration-300">ZTAKE</span>
            </div>
          </Link>
      ...
      <div
        className={cn(
          "lg:hidden fixed inset-x-0 top-[72px] p-4 transition-all duration-500 ease-in-out origin-top",
          mobileMenuOpen
            ? "opacity-100 translate-y-0 pointer-events-auto"
            : "opacity-0 -translate-y-4 pointer-events-none"
        )}
      >
        <div className="rounded-[32px] backdrop-blur-[60px] bg-white/90 dark:bg-black/90 border border-white/20 dark:border-white/10 shadow-2xl overflow-hidden">
